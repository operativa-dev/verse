...
The Verse CLI helps with design-time development and deployment tasks. It's primarily used to manage Migrations, but
also provides a way to query the database and output the model as JSON.
