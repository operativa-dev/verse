...
select "t7"."ArtistId", json_group_array(json_array("t7"."TrackId", "t7"."Name", "t7"."AlbumId", "t7"."GenreId", "t7"."Composer", "t7"."c0", "t7"."Title", "t7"."ArtistId", "t7"."c1", "t7"."c2")) as "c3"
from (
