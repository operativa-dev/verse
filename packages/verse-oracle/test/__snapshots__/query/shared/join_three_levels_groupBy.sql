...
select t8.ArtistId, json_arrayagg(json_array(t8.TrackId, t8.Name, t8.AlbumId, t8.GenreId, t8.Composer, t8.c0, t8.Title, t8.ArtistId, t8.c1, t8.c2) returning varchar2(32767)) c3
from (
