...
For this example, we will use SqlLite with the `@operativa/verse-sqlite` driver. Verse supports many database drivers, including PostgreSQL, MySQL, and SQLite. You can find the list of supported drivers in the [Database drivers](/docs/ref/database-drivers) section.
