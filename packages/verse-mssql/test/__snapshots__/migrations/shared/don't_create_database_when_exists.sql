...
create database "don't_create_database_when_exi"

-- Executing SQL: Parameters: [$1='don't_create_database_when_exi']
select 1
from "sys"."databases"
where "name" = @p0
...
where ("table_schema" = 'don''t_create_database_when_exi') and ("table_name" = @p0)
